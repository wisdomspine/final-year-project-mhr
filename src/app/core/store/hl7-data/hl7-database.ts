import { HL7Database } from './hl7-data.state';

export const hl7Database: HL7Database = {
  ABS: {
    segment: 'ABS',
    fields: [
      {
  ...
  DSC: {
    ...
    description: 'Continuation pointer used in messages with long text fields.',
  },
  DSP: {
    segment: 'DSP',
    fields: [
  ...
  NPU: {
    segment: 'NPU',
    fields: [{ field: 'NPU-2', description: 'Bed Status', segmentCode: 'NPU' }],
  ...
  OM2: {
    ...
    description: 'Contains numeric observation data for a patient or specimen.',
  },
  OM3: {
    segment: 'OM3',
    fields: [
  ...
  QID: {
    ...
    description: 'Definition of a query, including query parameters and values',
  },
  QPD: {
    segment: 'QPD',
    fields: [
  ...
  RMI: {
    ...
    description: 'Segment for reporting an incident related to patient safety.',
  },
  ROL: {
    segment: 'ROL',
    fields: [
  ...
  UB1: {
    ...
    title: 'UB-92 Data',
    description: "UB-92 Data related to patient's health care insurance claim.",
  },
  UB2: {
    segment: 'UB2',
    fields: [
...
export const profileSegments: { code: string; title: string }[] = [
  { code: 'PRD', title: 'Provider Data' },
  { code: 'AFF', title: 'Professional Affiliation' },
  { code: 'LAN', title: 'Language Detail' },
  { code: 'EDU', title: 'Educational Detail' },
  { code: 'CER', title: 'Certificate Detail' },
  { code: 'ORG', title: 'Practicing Organization' },
  { code: 'LOC', title: 'Practicing Location' },
  { code: 'DSP', title: 'Display Data' },
  { code: 'GT1', title: 'Guarantor' },
  { code: 'NK1', title: 'Next of Kin' },
  { code: 'VAR', title: 'Variability' },
  { code: 'ROL', title: 'Role' },
  { code: 'STF', title: 'Staff Identification' },
  { code: 'SCH', title: 'Scheduling Detail' },
  { code: 'ABS', title: 'Abstract' },
];

export const profileSegmentsMap: {[key:string]:{ code: string; title: string }} = profileSegments.reduce((prev, current) => {
  prev[current.code] = current;
  return prev;
}, {}  as any);
